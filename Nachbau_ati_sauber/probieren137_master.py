...
ele = Element(Emin=Emin,Emax=Emax,step=step,Element="Pb")
...
plt.xscale("log")
plt.yscale("log")
plt.title("Schwächungskoeffizienten von Pb")
#plt.ylim(10**9)
plt.legend(loc="upper right")
#plt.tight_layout()
plt.savefig("C:\\Users\\julia\\OneDrive\\Dokumente\\A_Christian\\Masterarbeit\\Masterarbeit\\Schwächungskoeffizienten.png", dpi=300, bbox_inches='tight')

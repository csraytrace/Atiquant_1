...
neue_Intensität = K.Intensität_alle_jit_fürMinimierung(normiert_Konz) * Geo
...
print("gemessene_Intensitäten", neue_Intensität,"berechnete_Intensität", K.Intensität_alle_jit_fürMinimierung(op_Konz) * Geo)
op_Konz_neu = K.Minimierung_relativ(Geo)
print("gemessene_Intensitäten", neue_Intensität,"berechnete_Intensität_neues_Res", K.Intensität_alle_jit_fürMinimierung(op_Konz_neu) * Geo)
Geo *= 1.1
#print("neuen_Intensitäten",neue_Intensität)
...
K = Calc_I(Element_Probe=30, Konzentration=neue_Intensität, P1 = [8,14,26], Messzeit=300, Emax=30)
print()
print("berechnung mit verändertem Geo")
print()
op_Konz = K.Minimierung_sqrt(Geo)
print("gemessene_Intensitäten", neue_Intensität,"berechnete_Intensität", K.Intensität_alle_jit_fürMinimierung(op_Konz) * Geo)
op_Konz_neu = K.Minimierung_relativ(Geo)
print("gemessene_Intensitäten", neue_Intensität,"berechnete_Intensität_neues_Res", K.Intensität_alle_jit_fürMinimierung(op_Konz_neu) * Geo)
print(K.Intensität_alle_jit_fürMinimierung(op_Konz) * Geo)
print()

#K = Calc_I(Element_Probe=30, Konzentration=neue_Intensität*10, P1 = [8,29,30], Fensterdicke_det=12, Messzeit=300, Emax=30)

#op_Konz = K.Minimierung(Geo*10)
